...
def test_certifying(n, n_test, nu_min, nu_max, auditor, alpha=0.1, sigma_noise=0.2, unbalance=0, nboot=10, balancing=None, lw=10**(-4)):
    """
    ...
    for nu in np.arange(nu_min, nu_max):
        ...
        protected = ('attr', 1)
        yname = 'predict'
        audit = ad.detector_data(auditor, test_sim, protected, yname, n=n_test, niter=300)
        audit.get_y()
